...
class TestExportImport(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        metadata = {
            self.client.spaces.ConfigurationMetaNames.NAME: 'client_space_export_' + self.space_name,
        ...
        metadata = {
            self.client.spaces.ConfigurationMetaNames.NAME: 'client_space_import_' + self.space_name,
            self.client.spaces.ConfigurationMetaNames.DESCRIPTION: self.space_name + ' description'
        }
