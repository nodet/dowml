...
class TestWMLClientWithDO(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        if self.wml_credentials['version'] == '2.0':
           TestWMLClientWithDO.skip_tests = True

    def test_01_set_space(self):
        if not TestWMLClientWithDO.skip_tests:
    ...
    # Doesn't work since it doesn't recognize the class variables
    # @unittest.skipUnless(not skip_tests, 'WML Server 2.0')
