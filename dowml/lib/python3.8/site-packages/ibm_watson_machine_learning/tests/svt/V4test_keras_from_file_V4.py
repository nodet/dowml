...
class TestWMLClientWithKeras(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.model_path = os.path.join(os.getcwd(), 'artifacts', 'keras_model.h5.zip')
...
#        print(K._backend)
        ...
        model_props = {
            self.client.repository.ModelMetaNames.NAME: "KerasModel",
            self.client.repository.ModelMetaNames.TYPE: "keras_2.1.6",
            self.client.repository.ModelMetaNames.RUNTIME_UID: "tensorflow_1.5-py3"
                       }
        published_model_details = self.client.repository.store_model(TestWMLClientWithKeras.model_path, meta_props=model_props)# , training_data=digits.data, training_target=digits.target)
    ...
    def test_04_get_details(self):
        ...
        self.assertTrue("Keras" in str(details_models))
    ...
    def test_05_create_deployment(self):
        ...
        self.assertTrue("Not a gzipped file" in str(deployment))
