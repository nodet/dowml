...
class TestWMLClientWithScikitLearn(unittest.TestCase):
    ...
    def test_02_publish_model(self):
        ...
        model_props = {
            self.client.repository.ModelMetaNames.NAME: "ScikitModel",
            self.client.repository.ModelMetaNames.TYPE: "scikit-learn_0.17",
            self.client.repository.ModelMetaNames.RUNTIME_UID: "scikit-learn_0.17-py3"
    ...
    def test_05_create_deployment(self):
        ...
        deployment = self.client.deployments.create(artifact_uid=self.model_uid, meta_props={self.client.deployments.ConfigurationMetaNames.NAME: "Test deployment",self.client.deployments.ConfigurationMetaNames.ONLINE:{}})
    ...
    def test_08_score(self):
        ...
        #scoring_data = { self.client.deployments.ScoringMetaNames.SCORING_INPUT_DATA : ['fields': ['Sepal.Length', 'Sepal.Width', 'Petal.Length', 'Petal.Width'], 'values': [[5.1, 3.5, 1.4, 0.2]]]}
        scoring_data = {
