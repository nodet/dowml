...
class TestAutoAIRemote(unittest.TestCase):
    ...
    data_location = './autoai/data/Hotel_Reviews.csv'


    # Hotel_reviews
    # asset_id = "52531b49-4e3b-419f-a169-0496dd08f44a" #1MB
    # asset_id = "32ad7c0a-5d51-47a7-b84c-6ee63e92282b"  # 10MB
    asset_id = "491ca337-e5c4-4b25-84c9-c4b9dd1b3b46" #full
    prediction_column = "Reviewer_Score"

    with_text_transformer = True

    OPTIMIZER_NAME = f"TEXT TRANSFORMER {with_text_transformer} regression {data_location.split('/')[-1]} full"
    ...
    def test_03_initialize_optimizer(self):
        TestAutoAIRemote.remote_auto_pipelines = self.experiment.optimizer(
            ...
            daub_include_only_estimators=[self.experiment.RegressionAlgorithms.LGBM, self.experiment.RegressionAlgorithms.XGB],
    ...
    def test_05_fit_run_training_of_auto_ai_in_wml(self):
        ...
        # TestAutoAIRemote.run_id = '51a3d5f2-3c72-4072-a578-f02ee5991e9b'
