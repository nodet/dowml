...
.. code:: python
     ...
     from ibm_s3transfer.processpool import ProcessPoolDownloader
...
* ``extra_args``: A dictionary containing any additional client arguments
  to include in the
  `GetObject <https://ibm_botocore.amazonaws.com/v1/documentation/api/latest/reference/services/s3.html#S3.Client.get_object>`_
...
.. code:: python
     ...
     ibm_botocore.exceptions.ClientError: An error occurred (404) when calling the HeadObject operation: Not Found
...
.. code:: python
     ...
     from ibm_s3transfer.processpool import ProcessPoolDownloader
     from ibm_s3transfer.processpool import ProcessTransferConfig
...
from ibm_s3transfer.constants import MB
from ibm_s3transfer.constants import ALLOWED_DOWNLOAD_ARGS
from ibm_s3transfer.constants import PROCESS_USER_AGENT
from ibm_s3transfer.compat import MAXINT
from ibm_s3transfer.compat import BaseManager
from ibm_s3transfer.exceptions import CancelledError
from ibm_s3transfer.exceptions import RetriesExceededError
from ibm_s3transfer.futures import BaseTransferFuture
from ibm_s3transfer.futures import BaseTransferMeta
from ibm_s3transfer.utils import S3_RETRYABLE_DOWNLOAD_ERRORS
from ibm_s3transfer.utils import calculate_num_parts
...
class ClientFactory(object):
    ...
    def create_client(self):
        """Create a ibm_botocore S3 client"""
        return ibm_botocore.session.Session().create_client(
